  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-zinc-400">
        ...
        end-to-end via OpenAPI. Edit{" "}
        <code className="rounded bg-zinc-900 px-1.5 py-0.5 text-sm">
          src/items.rs
        </code>{" "}
        and run <code className="rounded bg-zinc-900 px-1.5 py-0.5 text-sm">just typegen</code>{" "}
        to grow the API.
      </p>
      <div className="rounded-lg border border-zinc-800 p-4 text-sm">
        {health.isLoading && <span className="text-zinc-500">Checking backend…</span>}
        {health.isError && (
