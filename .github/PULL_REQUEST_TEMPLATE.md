...
- [ ] `just lint`
- [ ] `just test`
- [ ] `just check-typegen` (`just typegen` run and `schema.d.ts` committed if API changed)
- [ ] Other relevant gates: <!-- just build / just docker-build / just desktop-build -->
- Skipped gates and reason:

## Approval / risk notes

- Approval/discussion links:
- Migration files:
- Generated files:
...
- [ ] Defaults touching security, CORS, dependencies, release, migrations, generated files, or architecture link to approval
